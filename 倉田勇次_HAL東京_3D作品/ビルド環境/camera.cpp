...
// マクロ定義
//*****************************************************************************
#define	POS_X_CAM			(30.0f)			// カメラの初期位置(X座標)
...
#define UPPERLIMIT			(100.0f)		// カメラの上限
#define LOWERLIMIT			(10.0f)			// カメラの下限
...
// カメラリセットの目標地点をセット
void SetCameraReset(float posX, float posZ)
{
	g_ResetTargetPosX = posX;
	g_ResetTargetPosZ = posZ;
